<template>
  <div
    :class="[
      'flex flex-col md:flex-row gap-4 mb-2 p-3 rounded bg-zinc-800 border',
      dangerBorder ? 'border-red-400 ring-2 ring-red-400' : 'border-zinc-700',
    ]">
    ...
    <div class="flex flex-col justify-end">
      <button
        class="text-red-400 hover:text-red-200 py-2 px-3"
        @click="remove"
        @mouseenter="showRemoveBorderMethod"
        @mouseleave="hideRemoveBorderMethod">
        <svg
          class="h-5 w-5"
          fill="currentColor"
          width="64px"
          ...
          <g id="SVGRepo_iconCarrier">
            <path
              d="M50,8H38V2a2,2,0,0,0-2-2H16a2,2,0,0,0-2,2V8H2a2,2,0,0,0,0,4H9V50a2,2,0,0,0,2,2H41a2,2,0,0,0,2-2V12h7a2,2,0,0,0,0-4ZM18,4H34V8H18ZM39,48H13V12H39Z"></path>
            <path d="M26,14.45a2,2,0,0,0-2,2V44.89a2,2,0,0,0,4,0V16.45A2,2,0,0,0,26,14.45Z"></path>
            <path
              d="M33.56,14.45a2,2,0,0,0-2,2V44.89a2,2,0,1,0,4,0V16.45A2,2,0,0,0,33.56,14.45Z"></path>
            <path
              d="M18.44,14.45a2,2,0,0,0-2,2V44.89a2,2,0,0,0,4,0V16.45A2,2,0,0,0,18.44,14.45Z"></path>
          </g>
        </svg>
      </button>
    </div>
